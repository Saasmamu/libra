...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    POSTGRES_URL: process.env['POSTGRES_URL'] || 'dummy_postgres_url',
    ...
    STRIPE_WEBHOOK_SECRET: process.env['STRIPE_WEBHOOK_SECRET'] || 'dummy_webhook_secret',
    DATABASE_ID: process.env['DATABASE_ID'] || 'dummy_database_id',
